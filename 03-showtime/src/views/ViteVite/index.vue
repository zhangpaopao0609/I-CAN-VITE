...
import Import02 from "@assets/import-02.png";
import Import03 from "@assets/import-03.png";
...
<template>
  <div class="vite-vite">
    <h1>Vite 到底为什么这么 vite</h1>

    <h2 class="left-second-title">天时地利</h2>
    <el-row class="oneScreen" :gutter="40">
      <el-col :span="10" :offset="1" data-aos="zoom-in-up" data-aos-delay="500">
        <h4>得益于浏览器支持 ESM，使得 javascript 在一定程度上支持了模块化</h4>
      </el-col>
      <el-col :span="10" data-aos="zoom-in-up" data-aos-delay="500">
        <el-image @click="showESMImport" :src="Import00" />
    ...
    <el-row :gutter="30">
      <el-col data-aos="zoom-in-up" data-aos-delay="500" :offset="1" :span="6">
        ...
        <h4>
          总结： 1. 浏览器支持基本的 ESM 2. vite 基于原生 ESM 提供丰富的内建功能
        </h4>
      </el-col>
    </el-row>
  </div>
